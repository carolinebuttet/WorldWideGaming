...
var App={
        ...
        Host : {
            ...
            //switch player turn between 0 and 1
            App.playerTurn = 1-App.playerTurn;
            App.whosPlayerTurn = App.Host.playersWithPositions[App.playerTurn].mySocketId;
            App.Host.playersWithPositions[App.playerTurn].playerLat = App.Host.playerLat;
            App.Host.playersWithPositions[App.playerTurn].playerLng = App.Host.playerLng;
            console.log('switched turns');
            //make the changes of camera here!
            ...
            cesiumInit:function(){
                ...
                canvas.onclick = function() {
                    console.log('click!!!');
                    shootCount++;
                    console.log(shootCount + ' ' + targetCount);
                        if(shootCount===3){
                            shootCount=0;
                            chooseRandomTarget();
                    }
                ...
                makeOriginPoint(playerPosition);
                chooseRandomTarget();   
                makeOriginPoint(targetPosition);
                ...
                function chooseRandomTarget(){
                    ...
                    targetCount++;
                    var targetName = App.Host.cities[targetCount][0];
                    var targetLat = targetCollection[targetCount][1];
                    var targetLng = targetCollection[targetCount][2];
        ...
        Player : {
            ...
            showPosition:function (position) {
                ...
                if(App.Player.isGeolocated===true){
                    ...
                    //emit socket to say you're ready to display and then get the player data and then fire the 'customInit()'
                }
            },
            customInit: function(){
            ...
            customClick: function(){
                ...
                else if(App.Player.clickCount==2){
                document.getElementById('step00').style.display = "none";
                document.getElementById('step01').style.display = "none";
                ...
                else if(App.Player.clickCount==3){
                document.getElementById('step00').style.display = "none";
                document.getElementById('step01').style.display = "none";
                document.getElementById('step02').style.display = "none";
                ...
                else if(App.Player.clickCount==5){
                App.Player.clickCount=0;
                document.getElementById('step00').style.display = "block";
                document.getElementById('step01').style.display = "none";
                document.getElementById('step02').style.display = "none";
            ...
            goThrow: function(){
               ...
               if(App.Player.forceChoice==1){
                ...
                else if(App.Player.forceChoice==2){
                //sound
                ...
                else if(App.Player.forceChoice===3){
                //precision
