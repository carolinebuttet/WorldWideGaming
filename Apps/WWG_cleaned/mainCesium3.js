...
var App={
        ...
        bindEvents: function () {
            ...
            App.$doc.on('touchstart','#zoomPlus, #zoomRestartPlus', App.Player.zoomIn);
            App.$doc.on('touchend','#zoomPlus,#zoomRestartPlus', App.Player.stopZoomIn);
            App.$doc.on('touchstart','#zoomMinus,#zoomRestartMinus', App.Player.zoomOut);
            //App.$doc.on('click','#escapeZoom', App.Player.escapeZoom);
            App.$doc.on('touchend','#zoomMinus, #zoomRestartMinus', App.Player.stopZoomOut);
        ...
        Host : {
               ...
               console.log('Game is over for HOST');
                ...
                if(p1Score < p2Score){
                    ...
                    if(App.Host.playersWithPositions[0].teamColor==='blue'){
                        ...
                        $('#gameOverHostImg').attr('src','data/logo_game_over_orange.png'); 
            ...
            cesiumInit:function(){
                ...
                viewer.clock.onTick.addEventListener(function(clock) {
                    ...
                    var moveRate = cameraHeight / 150.0;
                    ...
                    /*çelse if(isFlying && App.Host.isBackward){
        ...
        Player : {
            ...
            if(App.Player.isRed===false){
                ...
                $('#waitMobileImg').attr('src','data/logo_basic_blue.png');
                $('#gameOverImgMobile').attr('src','data/logo_game_over_blue.png');
            }
